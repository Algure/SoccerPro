...
namespace Assets.FootballGameEngine_Indie.Scripts.Entities
{
    public class Goal : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            mManager = GameObject.Find("Manager").GetComponent<MatchManager>();
        }
        ...
        {
           if(Ball.Instance.OwnerWithLastTouch!=null && Ball.Instance.OwnerWithLastTouch.TeamGoal == this)
            {
                mManager.postOwnGoal(this);
            }
            else
            {
                mManager.postGoal(this);
            }
        }
